...
/// rendered body below it.
/// This is the published serialisation of the customer rendering, one file per
/// release, specified in <c>docs/output-format.md</c> of goldbarth/chartula-evals.
/// </summary>
