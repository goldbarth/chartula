...
/// <summary>
/// Composition root for generation and rendering. Both are pure domain logic over
/// the LLM seam; the pipeline depends only on the interfaces. Requires the LLM
/// services to be registered first.
/// </summary>
